...
//        self.removeObserver() // Notificationを画面が消えるときに削除
    ...
    func initLinkButton(){
        let font = UIFont.fontAwesome(ofSize: 22, style: .brands)
        amazonButton.titleLabel?.font = font
        var title = String.fontAwesomeIcon(name: .amazon)
...
//        var urlStr = "https://www.amazon.co.jp/s/ref=nb_sb_noss_2?__mk_ja_JP=\(bookTitle)&url=search-alias%3Daps&field-keywords=\(bookTitle)&x=0&Ay=0"
        var urlStr = "https://www.amazon.co.jp/dp/4334977421"
        ...
        title = String.fontAwesomeIcon(name: .twitter)
